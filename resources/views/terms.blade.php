...
@section('content')
  ...
  <div class="container pt-5">
    <p>A sua privacidade é importante para nós. É política do Praiser respeitar a sua privacidade em relação a qualquer
      informação sua que possamos coletar no site <a href=praiser.codewritters.space>Praiser</a>, e outros sites que
    ...
    <h2>Política de Cookies Praiser</h2>
    ...
    <ul>
      <li> Cookies relacionados à conta<br><br> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do
        ...
        porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao
        sair.<br><br> </li>
      <li> Cookies relacionados ao login<br><br> Utilizamos cookies quando você está logado, para que possamos lembrar
        ...
        áreas restritas ao efetuar login.<br><br> </li>
      ...
      <li> Cookies de preferências do site<br><br> Para proporcionar uma ótima experiência neste site, fornecemos a
        ...
        com uma página for afetada por suas preferências.<br> </li>
    </ul>
    ...
    <ul>
      <li> Este site usa o Google Analytics, que é uma das soluções de análise mais difundidas e confiáveis ​​da Web, para
        ...
        itens como quanto tempo você gasta no site e as páginas visitadas, para que possamos continuar produzindo conteúdo
        atraente. </li>
    </ul>
    ...
    <ul>
      <li> As análises de terceiros são usadas para rastrear e medir o uso deste site, para que possamos continuar
        ...
        visitadas, o que nos ajuda a entender como podemos melhorar o site para você.</li>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Praiser oferece no site e com
    ...
    <ul>
      ...
      <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
          ...
          hoje</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
      </li>
      <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Praiser, de seus fornecedores ou
